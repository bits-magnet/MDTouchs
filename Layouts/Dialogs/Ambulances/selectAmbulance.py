...
class Ui_selectHospital(object):
    ...
    def retranslateUi(self, selectHospital):
        ...
        self.title.setText(_translate("selectHospital", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Ambulance</span></p></body></html>"))
