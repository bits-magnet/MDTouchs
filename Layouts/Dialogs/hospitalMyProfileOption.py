...
class Ui_hospitalMyProfileDialog(object):
    ...
    def retranslateUi(self, hospitalMyProfileDialog):
        ...
        self.hospitalProfileLabel.setText(_translate("hospitalMyProfileDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Hospital</span></p><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Profile</span></p></body></html>"))
        self.adminProfileLabel.setText(_translate("hospitalMyProfileDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Admin<br/>Profile</span></p></body></html>"))
