...
class Ui_noticeDialog(object):
    ...
    def retranslateUi(self, noticeDialog):
        ...
        self.deleteNoticeLabel.setText(_translate("noticeDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Delete<br/>Notice</span></p></body></html>"))
        self.addNoticeLabel.setText(_translate("noticeDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Add<br/>Notice</span></p></body></html>"))
        self.viewNoticeLabel.setText(_translate("noticeDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">View<br/>Notice</span></p></body></html>"))
