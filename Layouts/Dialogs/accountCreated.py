...
class Ui_accountInfo(object):
    ...
    def retranslateUi(self, accountInfo):
        ...
        self.usernameLabel.setText(_translate("accountInfo", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">username :</span></p></body></html>"))
        self.passwordLabel.setText(_translate("accountInfo", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">password : </span></p></body></html>"))
        self.IDLabel.setText(_translate("accountInfo", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">ID : </span></p></body></html>"))
