...
class Ui_bloodDonationProfile(object):
    def setupUi(self, bloodDonationProfile):
        ...
        self.bloodDonationLabel.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
...
"font-weight: bold;")
        ...
        self.patientIDLabel.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
        ...
        self.eventIDLabel.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
        ...
        self.patientIDLabel_2.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
        ...
        self.patientIDLabel_3.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
    ...
    def retranslateUi(self, bloodDonationProfile):
        ...
        self.bloodDonationLabel.setText(_translate("bloodDonationProfile", "<html><head/><body><p><span style=\" font-size:16pt; text-decoration: underline;\">Blood Donation Record</span></p></body></html>"))
        ...
        self.eventIDLabel.setText(_translate("bloodDonationProfile", "<html><head/><body><p>Event ID <span style=\" font-size:10pt;\">(if any) </span><span style=\" font-size:16pt;\">:</span></p></body></html>"))
