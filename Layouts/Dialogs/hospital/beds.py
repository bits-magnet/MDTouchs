...
class Ui_bedsDialog(object):
    ...
    def retranslateUi(self, bedsDialog):
        ...
        self.bedRequestsLabel.setText(_translate("bedsDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Bed<br>Requests</span></p></body></html>"))
        self.bedRecordsLabel.setText(_translate("bedsDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Bed<br>Records</span></p></body></html>"))
        self.bedSystemLabel.setText(_translate("bedsDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Bed<br>System</span></p></body></html>"))
