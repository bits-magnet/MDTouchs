...
class Ui_billsDialog(object):
    ...
    def retranslateUi(self, billsDialog):
        ...
        self.createBillLabel.setText(_translate("billsDialog", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Create Bill</span></p></body></html>"))
        self.viewBillsLabel.setText(_translate("billsDialog", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">View Bills</span></p></body></html>"))
