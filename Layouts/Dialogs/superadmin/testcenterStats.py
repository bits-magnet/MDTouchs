...
"font-weight: bold;")
    ...
    def retranslateUi(self, testcenterStats):
        ...
        self.titleLabel.setText(_translate("testcenterStats", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; text-decoration: underline;\">Test Center Stats</span></p><p align=\"center\"><br/></p></body></html>"))
