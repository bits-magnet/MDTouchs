...
"font-weight: bold;")
    ...
    def retranslateUi(self, selectEmergencyService):
        ...
        self.title.setText(_translate("selectEmergencyService", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Remove Emergency Service</span></p></body></html>"))
