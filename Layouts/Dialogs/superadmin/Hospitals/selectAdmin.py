...
class Ui_selectAdmin(object):
    ...
    def retranslateUi(self, selectAdmin):
        ...
        self.title.setText(_translate("selectAdmin", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Admin</span></p></body></html>"))
