...
"border-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, selectAdmin):
        ...
        self.title.setText(_translate("selectAdmin", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Delete Admin</span></p></body></html>"))
