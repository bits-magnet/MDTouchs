...
class Ui_removeDispensary(object):
    ...
    def retranslateUi(self, removeDispensary):
        ...
        self.title.setText(_translate("removeDispensary", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Dispensary</span></p></body></html>"))
