...
class messageDoctorDialog(object):
    def setup(self, messageDoctorDialog):
    ...
    def retranslateUi(self, messageDoctorDialog):
        ...
        self.doctorMessageLabel.setText(_translate("messageDoctorDialog", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Doctors</span></p><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Message</span></p></body></html>"))
        self.broadcastMessageLabel.setText(_translate("messageDoctorDialog", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Broadcast</span></p><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Messages</span></p></body></html>"))
