...
class selectPrescription(object):
    ...
    def retranslateUi(self, selectPrescription):
        ...
        self.title.setText(_translate("selectPrescription", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Prescription</span></p></body></html>"))
