...
class bloodquanityList(object):
    ...
    def retranslateUi(self, bloodquanityList):
        ...
        self.titlelabel.setText(_translate("bloodquanityList", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Blood Quantity</span></p></body></html>"))
        ...
        item.setText(str(self.bloodbankdata["quantityAp"]))
        item = self.tableWidget.item(1,1)
        item.setText(str(self.bloodbankdata["quantityAn"]))
        item = self.tableWidget.item(2,1)
        item.setText(str(self.bloodbankdata["quantityBp"]))
        item = self.tableWidget.item(3,1)
        item.setText(str(self.bloodbankdata["quantityBm"]))
        item = self.tableWidget.item(4,1)
        item.setText(str(self.bloodbankdata["quantityABp"]))
        item = self.tableWidget.item(5,1)
        item.setText(str(self.bloodbankdata["quantityABm"]))
        item = self.tableWidget.item(6,1)
        item.setText(str(self.bloodbankdata["quantityOp"]))
        item = self.tableWidget.item(7,1)
        item.setText(str(self.bloodbankdata["quantityOm"]))
