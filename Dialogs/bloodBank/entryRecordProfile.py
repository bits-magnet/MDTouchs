...
class Ui_bloodentryProfile(object):
    def setupUi(self, bloodentryProfile):
        ...
        self.bloodEntry.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
...
"font-weight: bold;")
    ...
    def retranslateUi(self, bloodentryProfile):
        ...
        self.bloodEntry.setText(_translate("bloodentryProfile", "<html><head/><body><p><span style=\" font-size:16pt; text-decoration: underline;\">Blood Entry Record</span></p><p align=\"center\"><br/></p></body></html>"))
