...
class bloodDialog(object):
    ...
    def retranslateUi(self, bloodDialog):
        ...
        self.wasteRecordsLabel.setText(_translate("bloodDialog", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; text-decoration: underline;\">Waste Records</span></p></body></html>"))
        self.DonationRecordsLabel.setText(_translate("bloodDialog", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">Donation Records</span></p></body></html>"))
        self.billingRecordsLabel.setText(_translate("bloodDialog", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">Billing Records</span></p></body></html>"))
        self.entryRecordLabel.setText(_translate("bloodDialog", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">Entry Records</span></p></body></html>"))
