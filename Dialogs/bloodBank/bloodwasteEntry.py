...
"font-weight: bold;")
    ...
    def retranslateUi(self, bloodwasteEntry,grandparent,bloodbankHome):
        ...
        self.bloodBillingLabel.setText(_translate("bloodwasteEntry", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; text-decoration: underline;\">Blood Waste </span></p><p align=\"center\"><span style=\" font-size:16pt; text-decoration: underline;\">Entry</span></p></body></html>"))
