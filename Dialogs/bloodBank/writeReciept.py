...
"font-weight: bold;")
    ...
    def retranslateUi(self, bloodReciept,grandparent):
        ...
        self.bloodBillingLabel.setText(_translate("bloodReciept", "<html><head/><body><p><span style=\" font-size:16pt; text-decoration: underline;\">Blood Reciept</span></p></body></html>"))
