...
"font-weight: bold;")
    ...
    def retranslateUi(self, bloodRecievingProfile):
        ...
        self.bloodDonationLabel.setText(_translate("bloodRecievingProfile", "<html><head/><body><p><span style=\" font-size:16pt; text-decoration: underline;\">Blood Recieving Bill</span></p></body></html>"))
