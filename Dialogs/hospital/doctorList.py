...
"font-weight: bold;")
    ...
    def retranslateUi(self, doctorList):
        ...
        self.titleLabel.setText(_translate("doctorList", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; text-decoration: underline;\">Doctor List</span></p></body></html>"))
