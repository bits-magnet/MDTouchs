...
class viewEventDialog(object):
    ...
    def retranslateUi(self, viewEventDialog):
        ...
        self.allEventsLabel.setText(_translate("viewEventDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">All</span></p><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Events</span></p></body></html>"))
        self.myEventLabel.setText(_translate("viewEventDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">My</span></p><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Events</span></p><p align=\"center\"><br/></p></body></html>"))
