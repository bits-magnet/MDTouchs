...
"font-weight: bold;")
    ...
    def retranslateUi(self, hospitalStats):
        ...
        self.titleLabel.setText(_translate("hospitalStats", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; text-decoration: underline;\">Hospital Stats</span></p><p align=\"center\"><br/></p></body></html>"))
