...
class deleteEvent(object):
    ...
    def retranslateUi(self, deleteEvent):
        ...
        self.title.setText(_translate("deleteEvent",
                                      "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Delete Event</span></p></body></html>"))
        self.nameLabel.setText(_translate("deleteEvent",
                                          "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Name :</span></p></body></html>"))
        self.name.setText(_translate("deleteEvent", "event_name"))
        self.creatorLabel.setText(_translate("deleteEvent",
                                             "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Creator : </span></p></body></html>"))
        self.descriptionLabel.setText(_translate("deleteEvent",
                                                 "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Description :</span></p></body></html>"))
        self.dateLabel.setText(_translate("deleteEvent",
                                          "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Date : </span></p></body></html>"))
        self.venueLabel.setText(_translate("deleteEvent",
                                           "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Venue : </span></p></body></html>"))
