...
class addBloodBank(object):
    ...
    def retranslateUi(self, addBloodBank):
        ...
        self.title.setText(_translate("addBloodBank", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Add Blood Bank</span></p></body></html>"))
