...
class selectDoctor(object):
    ...
    def retranslateUi(self, selectDoctor):
        ...
        self.title.setText(_translate("selectDoctor",
                                      "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Doctor</span></p></body></html>"))
    ...
    def clickOnRemoveButton(self, parent):
        ...
        if id != "":
            if id.isdigit():
                import requests
                URL = "https://mdtouchs.herokuapp.com/api/doctor/" + str(id)
    ...
    def doctorComboBoxAdd(self,parent):
        ...
        print(workplace_id)
        import requests
        URL = "https://mdtouchs.herokuapp.com/api/doctor/"
        param = {
