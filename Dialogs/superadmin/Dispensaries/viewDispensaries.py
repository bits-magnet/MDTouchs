...
class Widget1(QWidget):
    def __init__(self,parent = None):
        ...
        self.dispensaryIdLabel.setStyleSheet("text-align:left;font-size:16pt;font-weight:550;")
        self.dispensaryNameLabel.setGeometry(QRect(180,10,1000,30))
        self.dispensaryNameLabel.setText("Patidar Samaj dispensary ")
        self.dispensaryNameLabel.setStyleSheet("align:left;font-size:20pt;font-weight:600;")
...
class viewDispensary(object):
    ...
    def setup(self, dispensaryListDialog):
        ...
        self.dispensaryListHeader.setStyleSheet("font: 68 39pt \"Ubuntu\";\n"
