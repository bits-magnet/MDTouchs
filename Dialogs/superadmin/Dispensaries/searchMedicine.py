...
"font-weight: bold;")
    ...
    def retranslateUi(self, searchMedicine):
        ...
        self.titleLabel.setText(_translate("searchMedicine", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; text-decoration: underline;\">Search Medicine</span></p></body></html>"))
