...
"font-weight: bold;")
    ...
    def retranslateUi(self, searchTest):
        ...
        self.titleLabel.setText(_translate("searchTest", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; text-decoration: underline;\">Search Tests</span></p></body></html>"))
