...
class selectHospital(object):
    ...
    def retranslateUi(self, selectHospital):
        ...
        self.title.setText(_translate("selectHospital", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Hospital</span></p></body></html>"))
    ...
    def clickOnRemoveHospital(self, parent):
        ...
        if self.searchByID.text() != "":
            ...
            if id.isdigit():
                import requests
                url = "https://mdtouchs.herokuapp.com/MDTouch/api/hospital/" + id
