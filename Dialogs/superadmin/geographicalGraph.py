...
class geographicalGraph(object):
    ...
    def retranslateUi(self, geographicalGraph):
        ...
        self.titleLabel.setText(_translate("geographicalGraph", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; text-decoration: underline;\">Geographical Comparision With Medical Services</span></p></body></html>"))
