...
"font-weight: bold;")
        ...
        self.addNoticeLabel.setStyleSheet("font-size:14pt;\n"
"font-weight: bold;")
    ...
    def retranslateUi(self, deleteNotice):
        ...
        self.addNoticeLabel.setText(_translate("deleteNotice", "<html><head/><body><p><span style=\" font-size:16pt; text-decoration: underline;\">Delete Notice</span></p></body></html>"))
