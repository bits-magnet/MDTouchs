...
class selectNotice(object):
    ...
    def retranslateUi(self, selectNotice):
        ...
        self.title.setText(_translate("selectNotice", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; text-decoration: underline;\">Select Notice</span></p></body></html>"))
