...
class bloodbankGraph(object):
    ...
    def retranslateUi(self, geographicalGraph):
        ...
        self.titleLabel.setText(_translate("geographicalGraph", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; text-decoration: underline;\">Half Month Report Of Blood Banks</span></p></body></html>"))
