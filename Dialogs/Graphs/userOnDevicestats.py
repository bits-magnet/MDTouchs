...
class geographicalGraph(object):
    ...
    def retranslateUi(self, geographicalGraph):
        ...
        self.titleLabel.setText(_translate("geographicalGraph", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; text-decoration: underline;\">Traffic On Services</span></p></body></html>"))
        ...
        self.titleLabel_3.setText(_translate("geographicalGraph", "<html><head/><body><p align=\"center\">Month : 'DEC'</p></body></html>"))
